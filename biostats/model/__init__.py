...
from .others_test import screening_test, epidemiologic_study, factor_analysis, principal_component_analysis, linear_discriminant_analysis
...
from .others_plot import heatmap, fa_plot, pca_plot, lda_plot