...
from .logistic_regression import simple_logistic_regression, multiple_logistic_regression
...
from .others_test import linear_discriminant_analysis
...
from .others_plot import lda_plot